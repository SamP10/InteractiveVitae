...
export default function Homepage() {
    return (
        <div className="flex overflow-hidden">
            ...
            <div className="flex flex-col max-w-full max-h-full mt-6">
                ...
                <div className="flex">
                    <a
                        ...
                        aria-label="GitHub"
                        className={`${TYPOGRAPHY.fontFamilies.youngSerif} ${SPACING.textSize.subtitle} animate-slide-in-right-0_8Second-with_0_17s-delay leading-none text-cream opacity-0 mt-2 mr-2`}>
