...
export default function WorkTogether() {
    ...
    const socialLinks = [
        ...
        {
            name: 'LinkedIn',
            url: 'https://www.linkedin.com/in/sam-plant10/',
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Email',
            url: 'mailto:samplant10@gmail.com',
            icon: (
    ...
    return (
        <section id="work-together" className="py-20 px-4 bg-cream">
            <div className="max-w-4xl mx-auto text-center">
                ...
                {/* Headline */}
                <h2
                    className="text-4xl md:text-5xl font-limelight text-darkPine mb-6 animate-text-reveal"
                ...
                {/* Underline */}
                <div
                    className="w-32 h-1 bg-moss mx-auto rounded-full mb-8 animate-text-reveal"
                ...
                {/* Social links */}
                <div
                    className="flex justify-center gap-4 animate-text-reveal"
                    ...
                    {socialLinks.map((link) => (
                        <a
                            ...
                            className="p-3 bg-darkPine text-cream rounded-full hover:bg-moss transition-colors duration-300"
                            title={link.name}>
                            {link.icon}
                        </a>
                    ))}
